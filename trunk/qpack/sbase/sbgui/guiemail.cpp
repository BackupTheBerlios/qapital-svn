...
sbgui::GUIEMail::GUIEMail(QWidget *parent, const char *name)
...
sbgui::GUIEMail::~GUIEMail()
{
	qDebug("[Destruyendo GUIFormularioGeneral]");
}

void sbgui::GUIEMail::crearFormulario(QStringList cabecera)
{
...
void sbgui::GUIEMail::clickedInsertar()
{
	//falta: validar datos
