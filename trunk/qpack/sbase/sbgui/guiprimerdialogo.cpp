...
*/
sbgui::GUIPrimerDialogo::GUIPrimerDialogo(const char *nombre)
...
* Destructor
*/
sbgui::GUIPrimerDialogo::~GUIPrimerDialogo()
{
...
*/
void sbgui::GUIPrimerDialogo::crearIntroduccion()
{
...
*/
void sbgui::GUIPrimerDialogo::crearTipoInterfaz()
{
...
*/
void sbgui::GUIPrimerDialogo::selecionTipo(int id)
{
...
*/
void sbgui::GUIPrimerDialogo::crearConfigRed()
{
...
*/
int sbgui::GUIPrimerDialogo::interfazElegida()
{
	return tipo;
}
...
*/
QString sbgui::GUIPrimerDialogo::obtenerHost()
{
	return catHost->text();
}
...
*/
QString sbgui::GUIPrimerDialogo::obtenerPuerto()
{
