...
sbgui::GUITelefonos::GUITelefonos(QWidget *parent, const char *name) : GUIFormularios(parent, name)
{
...
sbgui::GUITelefonos::~GUITelefonos()
{
	qDebug( "[GUITelefonos destruido]" );
}


void sbgui::GUITelefonos::crearFormulario(QStringList cabecera)
{
...
void sbgui::GUITelefonos::departamentoSelecionado(int index)
{
...
void sbgui::GUITelefonos::clickedInsertar()
{
