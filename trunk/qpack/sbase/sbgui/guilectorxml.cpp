...
sbgui::GUILectorXml::GUILectorXml() : QXmlDefaultHandler(), qName(""), leer(false), numeroDeBotones(0), numeroDeMenus(0), filas(0), columnas(0), mnid(0)
{
}

// Esta funcion lee los elementos de apertura: <apertura>
bool sbgui::GUILectorXml::startElement (const QString& ns, const QString& localname, const QString& qname, const QXmlAttributes& atts)
{
	qName = qname;
...
bool sbgui::GUILectorXml::endElement( const QString& ns, const QString& localname, const QString& qname)
{
...
bool sbgui::GUILectorXml::characters ( const QString & ch )
{
	if (leer)
	{
		if (raiz == "GMNS" )
...
bool sbgui::GUILectorXml::parseContinue ()
{
	numeroDeBotones = 0;
	numeroDeMenus = 0;
	filas = 0;
...
QStringList sbgui::GUILectorXml::obtenerListaDeTexto() const 
{
	return listaDeTexto;
}

QStringList sbgui::GUILectorXml::obtenerListaDeTexto(int mnid)
{
...
int sbgui::GUILectorXml::obtenerNumeroDeBotones(int mnid) const
{
...
int sbgui::GUILectorXml::obtenerNumeroDeMenus() const
{
	return numeroDeMenus;
}

int sbgui::GUILectorXml::obtenerFilas(int mnid) const
{
	return listaDeFilas[mnid];
}

int sbgui::GUILectorXml::obtenerColumnas(int mnid) const
{
	return listaDeColumnas[mnid];
}

QStringList sbgui::GUILectorXml::obtenerListaDeFunciones(int mnid)
{
	QStringList listaTemporal;
	int inicio = 0, final = 0;
