...
sbgui::GUITabla::GUITabla(int filas, QStringList encabezado, QWidget *parent, const char *name)
:QTable(parent, name)
{
...
sbgui::GUITabla::~GUITabla()
{
}

void sbgui::GUITabla::ajustarTamano(int fila, int columna)
{
...
void sbgui::GUITabla::llenarTabla(QStringList strlist)
{
	int cont = 0;
...
QStringList sbgui::GUITabla::obtenerDatos()
{
	QStringList datos;
	int cont = 0;
...
void sbgui::GUITabla::removerFilaSeleccionada()
{
