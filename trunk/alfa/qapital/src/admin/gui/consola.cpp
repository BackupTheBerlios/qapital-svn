 ...
 */
Consola::Consola(QWidget *parent, const char *name) : QDockWindow(QDockWindow::InDock,parent,name)
{
	INIQPC;
	...
	tab->addTab(vbox, "Consola");
	show();
}

/**
Destructor de Consola
 */
Consola::~Consola()
{
	FINQPC;
 ...
 */
void Consola::addText(QString texto)
{
