...
GUIDirecciones::GUIDirecciones(QWidget *parent, const char *name) : GUIFormularios(parent, name)
{
...
GUIDirecciones::~GUIDirecciones()
{
	qDebug("[Destruyendo GUIDirecciones]");
}

void GUIDirecciones::crearFormulario(QStringList cabecera)
{
...
void GUIDirecciones::departamentoSelecionado(int index)
{
...
void GUIDirecciones::clickedInsertar()
{
...
QStringList GUIDirecciones::obtenerDatos()
{
