...
GUIBarraIconos::GUIBarraIconos( QMainWindow * padre , const char * nombre, int numBotones )
...
GUIBarraIconos::GUIBarraIconos( QMainWindow * padre , const char * nombre, QString archivoXml)
{
}
...
void GUIBarraIconos::gbrPonerIcono(QString fileName, int id)
{
