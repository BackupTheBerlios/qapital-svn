...
GUIFormularioGeneral::GUIFormularioGeneral(QWidget *parent, const char *name) : GUIFormularios(parent, name)
{
...
GUIFormularioGeneral::~GUIFormularioGeneral()
{
	qDebug("[Destruyendo GUIFormularioGeneral]");
}

void GUIFormularioGeneral::crearFormulario(QStringList cabecera)
{
...
void GUIFormularioGeneral::clickedInsertar()
{
	//falta: validar datos
