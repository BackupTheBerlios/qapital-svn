...
GUIFormularios::GUIFormularios(QWidget *parent, const char *name)
 : QVGroupBox(parent, name)
{
}


GUIFormularios::~GUIFormularios()
{
}

void GUIFormularios::crearTabla(QStringList cabecera)
{
...
void GUIFormularios::crearBotones()
{ 
