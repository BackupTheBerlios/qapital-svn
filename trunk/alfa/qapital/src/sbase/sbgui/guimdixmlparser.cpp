 ...
 */
GUIMdiXMLParser::GUIMdiXMLParser() : QXmlDefaultHandler(), leer(false)
{
}
...
Destructor 
 */
GUIMdiXMLParser::~GUIMdiXMLParser()
{
}
 ...
 */
bool GUIMdiXMLParser::startElement ( const QString &, const QString &, const QString& qName, const QXmlAttributes & atts)
{
	tag = qName;
	if (qName == "Menu")
	{
 ...
 */
bool GUIMdiXMLParser::endElement (const QString &, const QString & , const QString& qName)
{
	if (qName == "Menu")
	{
 ...
 */
bool GUIMdiXMLParser::characters ( const QString & ch )
{
	if (tag == "texto" && leer)
	{
		leer = false;
 ...
 */
HashMenu GUIMdiXMLParser::obtenerMenus()
{
	return menus;
}
 ...
 */
QStringList GUIMdiXMLParser::obtenerNombres()
{
	return names;
}
